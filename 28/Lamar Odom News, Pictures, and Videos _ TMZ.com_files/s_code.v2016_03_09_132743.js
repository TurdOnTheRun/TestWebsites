...
function s_doPlugins(s) {
    ...
    s.prop15 = s.eVar15 = s.getTimeParting("h", "-8", currentYear); // Set hour
    s.prop16 = s.eVar16 = s.getTimeParting("d", "-8", currentYear); // Set day
    s.prop17 = s.eVar17 = s.getTimeParting("w", "-8", currentYear); // Set Weekend / Weekday
