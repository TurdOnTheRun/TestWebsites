...
function init() {
	...
	setTimeout(function(){ typeIt('t1-1', 240, 0)}, 2900);
	setTimeout(function(){ typeIt('t1-2', 200, 28)}, 4000);
	...
	//FRAME 6
	setTimeout(function(){ typeIt('t2-1', 160, 0)}, 9800);
	setTimeout(function(){ typeIt('t2-2', 245, 28)}, 11100);
