...
var ft1782315 = {
	confID:window.ftConfID_1782315||"0",
	GUID:window.ftGUID_1782315||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1782315 && window.ftImp1782315.impID || '',
	params:window.ftParams_1782315||"",
	segment:window.ftSegment_1782315||"",
	segmentList:window.ftSegmentList_1782315||[],
	keyword:window.ftKeyword_1782315||"",
	ftReturn: window.ftReturn_1782315||"",
	exttrack:[],
	extscript:[""],
	pID:"1782315",
	cID:"49467",
	...
	placementDescription:"TMODataStoryDemandGen300x600",
	creativeID:"1372536",
	width:300,
	height:600,
	divID:"ftdiv1782315",
	frameID:"ftframe1782315",
	altImgID:"ftalt1782315",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/3/60752;1782315;1372536;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=http://www.tmobile.com",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/3/60752;1782315;1372536;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=http://www.tmobile.com"],
	altImg:"http://servedby.flashtalking.com/imp/3/60752;1782315;204;gif;Flashtalkingcom;TMODataStoryDemandGen300x600/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/60752;1782315;202;pixel;Flashtalkingcom;TMODataStoryDemandGen300x600/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/49467/1372536/TMO_GeneralMarket_Network_300x600.html",
	...
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?64830368-1782315;1372536;",
	centreAd:true,
    iDeviceImp:"http://servedby.flashtalking.com/imp/3/60752;1782315;207;guid;Flashtalkingcom;TMODataStoryDemandGen300x600/?ft_guid=[%"+"FT_GUID%]&cachebuster=[%"+"CACHEBUSTER%]",
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	eventListeners:{},
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1782315[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1782315'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1782315 && window.ftImp1782315.jsAppend)) {
...
//--start extensions
(function(ft) {    ft.addVClick = function(ct) {        var o = this;        var pubClick = o.decode(o.qs('click', ''));        var destURL = "";        destURL = pubClick.substring(pubClick.lastIndexOf("http"));        pubClick = pubClick.substring(0, pubClick.lastIndexOf("http"));        if (pubClick) {            ct = ct.split("&url=")[0] + "&url=";            if (pubClick.indexOf("bluekai") == -1) {                return pubClick + ct + destURL; //URLs swapped so FT tracking fires first            } else {                if((pubClick.match(/doubleclick/g) || []).length > 1){                    return pubClick + encodeURIComponent(encodeURIComponent(ct)) + encodeURIComponent(encodeURIComponent(destURL));                }                else{                    return pubClick + encodeURIComponent(ct) + encodeURIComponent(destURL);                }                 //URLs swapped so FT tracking fires first            }        } else {            return ct + destURL;        }    }}(ft1782315));
