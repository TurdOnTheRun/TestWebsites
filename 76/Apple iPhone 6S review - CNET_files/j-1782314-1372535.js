...
var ft1782314 = {
	confID:window.ftConfID_1782314||"0",
	GUID:window.ftGUID_1782314||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1782314 && window.ftImp1782314.impID || '',
	params:window.ftParams_1782314||"",
	segment:window.ftSegment_1782314||"",
	segmentList:window.ftSegmentList_1782314||[],
	keyword:window.ftKeyword_1782314||"",
	ftReturn: window.ftReturn_1782314||"",
	exttrack:[],
	extscript:[""],
	pID:"1782314",
	cID:"49467",
	...
	placementDescription:"TMODataStoryDemandGen300x250",
	creativeID:"1372535",
	width:300,
	height:250,
	divID:"ftdiv1782314",
	frameID:"ftframe1782314",
	altImgID:"ftalt1782314",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/3/60752;1782314;1372535;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.tmobile.com",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/3/60752;1782314;1372535;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.tmobile.com"],
	altImg:"http://servedby.flashtalking.com/imp/3/60752;1782314;204;gif;Flashtalkingcom;TMODataStoryDemandGen300x250/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/3/60752;1782314;202;pixel;Flashtalkingcom;TMODataStoryDemandGen300x250/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/49467/1372535/TMO_GeneralMarket_Network_300x250.html",
	...
	statBaseURL:"http://stat.flashtalking.com/reportV3/ft.stat?64830367-1782314;1372535;",
	centreAd:true,
    iDeviceImp:"http://servedby.flashtalking.com/imp/3/60752;1782314;207;guid;Flashtalkingcom;TMODataStoryDemandGen300x250/?ft_guid=[%"+"FT_GUID%]&cachebuster=[%"+"CACHEBUSTER%]",
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	eventListeners:{},
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1782314[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1782314'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1782314 && window.ftImp1782314.jsAppend)) {
