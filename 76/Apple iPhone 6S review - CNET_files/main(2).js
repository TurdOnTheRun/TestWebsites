...
function setupBanner() {
	...
	frame6SubHeadline2_img.style.top = myFT.instantAds.F6_subHeadline2_offsetY;
...
function playFrame6() {
	...
	if(useRL === "true" || useRL === "TRUE") {
		...
		TweenLite.to(frame6SubHeadline2_img, speeds[3], {css:{left:0}, delay:delays[3]});
	}
	...
	TweenLite.to(legal_f6_div, speeds[5], {css:{opacity:1}, delay:delays[5]});
}
