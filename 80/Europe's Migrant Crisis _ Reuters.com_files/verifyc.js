$dvbsr.pubSub.subscribe('BeforeDecisionRender', 'f72ead8b15cf44aca58677ebdab09d69', 'ModifyAdTagWithBsImpId', function(){var impId = 'f72ead8b15cf44aca58677ebdab09d69';if($dvbsr && $dvbsr.tags[impId] && typeof($dvbsr.tags[impId].redirect) == 'object' && typeof($dvbsr.tags[impId].redirect.tagsrc) == 'string') {$dvbsr.tags[impId].redirect.tagsrc = $dvbsr.tags[impId].redirect.tagsrc.replace(/\[url_encoded_publisher_data\]/g,encodeURIComponent('f72ead8b15cf44aca58677ebdab09d69'));}});setTimeout(function(){
    'use strict';
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'f72ead8b15cf44aca58677ebdab09d69',
                comparisonItems:[{name : 'cmp', value : 3340716},{name : 'plmt', value : 3340732}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_1460007503438478');
                if (frame) {
