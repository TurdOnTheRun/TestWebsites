...
function CApp( jobj )
{
	...
	this.url_app_entry = 'http://jurassicworld.org/web/ajax-poll.php';
	this.url_app_root = 'http://jurassicworld.org/web/';
	this.url_app_img = 'http://jurassicworld.org/web/app.img/';
