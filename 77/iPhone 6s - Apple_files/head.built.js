...
};c.exports=f},{"./data":4,"ac-polyfills/Array/prototype.filter":63,"ac-polyfills/Array/prototype.some":66}],3:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":7,"ac-polyfills/Array/prototype.slice":65,"ac-polyfills/Element/prototype.classList":67}],6:[function(b,c,a){c.exports={add:b("./className/add"),contains:b("./className/contains"),remove:b("./className/remove")}
...
}return f(h,g)}},{"./className/contains":8,"ac-polyfills/Element/prototype.classList":67}],12:[function(b,c,a){c.exports={add:b("./add"),contains:b("./contains"),remove:b("./remove"),toggle:b("./toggle")}
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":10,"ac-polyfills/Array/prototype.slice":65,"ac-polyfills/Element/prototype.classList":67}],14:[function(c,d,b){c("ac-polyfills/Element/prototype.classList");
...
}},{"./className":6,"ac-polyfills/Element/prototype.classList":67}],15:[function(b,c,a){var g=b("./helpers/globals");
...
c.exports.original=d},{"./helpers/globals":23,"ac-function/once":37}],16:[function(c,d,b){var h=c("ac-browser");
var a=c("./touchAvailable").original;var f=c("ac-function/once");function g(){return(!a()||(h.os==="iOS"&&h.version>=8)||h.name==="Chrome")
}d.exports=f(g);d.exports.original=g},{"./touchAvailable":53,"ac-browser":32,"ac-function/once":37}],17:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":23,"ac-function/once":37}],18:[function(c,d,b){var g=c("ac-prefixer/getStyleValue");
...
},{"ac-function/once":37,"ac-prefixer/getStyleValue":40}],19:[function(c,d,b){var g=c("ac-prefixer/getStyleValue");
var f=c("ac-prefixer/getStyleProperty");var h=c("ac-function/memoize");function a(j,i){if(typeof i!=="undefined"){return !!g(j,i)
}else{return !!f(j)}}d.exports=h(a);d.exports.original=a},{"ac-function/memoize":36,"ac-prefixer/getStyleProperty":39,"ac-prefixer/getStyleValue":40}],20:[function(b,c,a){var f=b("ac-prefixer/getStyleValue");
var d=b("ac-function/once");function g(){return !!f("margin","1vw 1vh")}c.exports=d(g);
c.exports.original=g},{"ac-function/once":37,"ac-prefixer/getStyleValue":40}],21:[function(b,d,a){var f=b("./helpers/globals");
var g=b("ac-function/memoize");function c(h,j){var i=f.getDocument();var k;j=j||"div";
k=i.createElement(j);return(h in k)}d.exports=g(c);d.exports.original=c},{"./helpers/globals":23,"ac-function/memoize":36}],22:[function(c,f,b){var a=c("ac-prefixer/getEventType");
var g=c("ac-function/memoize");function d(i,h){return !!a(i,h)}f.exports=g(d);f.exports.original=d
},{"ac-function/memoize":36,"ac-prefixer/getEventType":38}],23:[function(b,c,a){c.exports={getWindow:function(){return window
...
return(!a()&&!i.orientation)}f.exports=g(c);f.exports.original=c},{"./helpers/globals":23,"./touchAvailable":53,"ac-function/once":37}],26:[function(f,g,c){var d=f("./isDesktop").original;
var a=f("./isTablet").original;var h=f("ac-function/once");function b(){return(!d()&&!a())
}g.exports=h(b);g.exports.original=b},{"./isDesktop":25,"./isTablet":28,"ac-function/once":37}],27:[function(b,c,a){var d=b("./helpers/globals");
...
}g.exports=h(a);g.exports.original=a},{"./helpers/globals":23,"./isDesktop":25,"ac-function/once":37}],29:[function(c,d,a){var g=c("./helpers/globals");
var f=c("ac-function/once");function b(){var j=g.getWindow();var i=false;try{i=!!(j.localStorage&&j.localStorage.non_existent!==null)
}catch(h){}return i}d.exports=f(b);d.exports.original=b},{"./helpers/globals":23,"ac-function/once":37}],30:[function(b,c,a){var g=b("./helpers/globals");
var d=b("ac-function/once");function f(){var h=g.getWindow();return("HTMLMediaElement" in h)
}c.exports=d(f);c.exports.original=f},{"./helpers/globals":23,"ac-function/once":37}],31:[function(c,d,b){c("ac-polyfills/matchMedia");
...
},{"./helpers/globals":23,"ac-function/once":37,"ac-polyfills/matchMedia":68}],32:[function(b,c,a){arguments[4][1][0].apply(a,arguments)
},{"./ac-browser/BrowserData":33,"./ac-browser/IE":34,dup:1}],33:[function(b,c,a){var d=b("./data");
...
h.os=g.__getOS(d.os);h.osVersion=g.__getOSVersion(d.versionString,h.os);return h
};c.exports=f},{"./data":35}],34:[function(b,c,a){arguments[4][3][0].apply(a,arguments)
},{dup:3}],35:[function(b,c,a){c.exports={browser:[{string:window.navigator.userAgent,subString:"Chrome",identity:"Chrome"},{string:window.navigator.userAgent,subString:/silk/i,identity:"Silk"},{string:window.navigator.userAgent,subString:"OmniWeb",versionSearch:"OmniWeb/",identity:"OmniWeb"},{string:window.navigator.userAgent,subString:/mobile\/[^\s]*\ssafari\//i,identity:"Safari Mobile",versionSearch:"Version"},{string:window.navigator.vendor,subString:"Apple",identity:"Safari",versionSearch:"Version"},{prop:window.opera,identity:"Opera",versionSearch:"Version"},{string:window.navigator.vendor,subString:"iCab",identity:"iCab"},{string:window.navigator.vendor,subString:"KDE",identity:"Konqueror"},{string:window.navigator.userAgent,subString:"Firefox",identity:"Firefox"},{string:window.navigator.vendor,subString:"Camino",identity:"Camino"},{string:window.navigator.userAgent,subString:"Netscape",identity:"Netscape"},{string:window.navigator.userAgent,subString:"MSIE",identity:"IE",versionSearch:"MSIE"},{string:window.navigator.userAgent,subString:"Trident",identity:"IE",versionSearch:"rv"},{string:window.navigator.userAgent,subString:"Gecko",identity:"Mozilla",versionSearch:"rv"},{string:window.navigator.userAgent,subString:"Mozilla",identity:"Netscape",versionSearch:"Mozilla"}],os:[{string:window.navigator.platform,subString:"Win",identity:"Windows",versionSearch:"Windows NT"},{string:window.navigator.platform,subString:"Mac",identity:"OS X"},{string:window.navigator.userAgent,subString:"iPhone",identity:"iOS",versionSearch:"iPhone OS"},{string:window.navigator.userAgent,subString:"iPad",identity:"iOS",versionSearch:"CPU OS"},{string:window.navigator.userAgent,subString:/android/i,identity:"Android"},{string:window.navigator.platform,subString:"Linux",identity:"Linux"}],versionString:window.navigator.userAgent||window.navigator.appVersion||undefined}
},{}],36:[function(c,d,b){var a=function(){var h="";var g;for(g=0;g<arguments.length;
...
}return g.cache[k]};g.cache={};return g}},{}],37:[function(b,c,a){c.exports=function d(g){var f;
return function(){if(typeof f==="undefined"){f=g.apply(this,arguments)}return f
}}},{}],38:[function(d,b,f){var g=d("./utils/eventTypeAvailable");var j=d("./shared/camelCasedEventTypes");
...
}return o[m]=false}},{"./shared/camelCasedEventTypes":41,"./shared/prefixHelper":43,"./shared/windowFallbackEventTypes":46,"./utils/eventTypeAvailable":47}],39:[function(f,d,h){var a=f("./shared/stylePropertyCache");
...
}return c(p,n[m])}}return c(p,false)}},{"./shared/getStyleTestElement":42,"./shared/prefixHelper":43,"./shared/stylePropertyCache":44,"./utils/toCSS":48,"./utils/toDOM":49}],40:[function(d,b,h){var f=d("./getStyleProperty");
...
}},{"./getStyleProperty":39,"./shared/prefixHelper":43,"./shared/stylePropertyCache":44,"./shared/styleValueAvailable":45}],41:[function(b,c,a){c.exports={transitionend:["webkitTransitionEnd","MSTransitionEnd"],animationstart:["webkitAnimationStart","MSAnimationStart"],animationend:["webkitAnimationEnd","MSAnimationEnd"],animationiteration:["webkitAnimationIteration","MSAnimationIteration"],fullscreenchange:["MSFullscreenChange"],fullscreenerror:["MSFullscreenError"]}
},{}],42:[function(c,d,b){var f;d.exports=function a(){if(!f){f=document.createElement("_")
}else{f.style.cssText="";f.removeAttribute("style")}return f};d.exports.resetElement=function(){f=null
}},{}],43:[function(b,d,a){var i=["-webkit-","-moz-","-ms-"];var f=["Webkit","Moz","ms"];
...
},{}],44:[function(b,c,a){c.exports={}},{}],45:[function(c,b,d){var a=c("./stylePropertyCache");
...
}},{"./getStyleTestElement":42,"./stylePropertyCache":44}],46:[function(b,c,a){c.exports=["transitionend","animationstart","animationend","animationiteration"]
},{}],47:[function(c,f,b){var a={window:window,document:document};f.exports=function d(i,g){var h;
...
}return false}},{}],48:[function(c,d,b){var f=/^(webkit|moz|ms)/gi;d.exports=function a(h){var g;
...
}return h}},{}],50:[function(c,d,b){var g=c("./helpers/globals");var f=c("ac-function/once");
...
d.exports.original=a},{"./helpers/globals":23,"ac-function/once":37}],51:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":23,"ac-function/once":37}],52:[function(b,c,a){var g=b("ac-prefixer/getStyleValue");
var d=b("ac-function/once");function f(){return !!(g("perspective","1px")&&g("transform","translateZ(0)"))
}c.exports=d(f);c.exports.original=f},{"ac-function/once":37,"ac-prefixer/getStyleValue":40}],53:[function(c,d,b){var g=c("./helpers/globals");
var f=c("ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":23,"ac-function/once":37}],54:[function(c,d,b){var g=c("./helpers/globals");
...
}return false}d.exports=f(a);d.exports.original=a},{"./helpers/globals":23,"ac-function/once":37}],55:[function(b,d,a){var g=b("ac-classlist/add");
...
}}};d.exports=c},{"ac-classlist/add":5,"ac-classlist/remove":13,"ac-object/extend":62}],56:[function(d,h,c){var i=d("ac-browser");
...
},{"ac-browser":58,"ac-feature/svgAvailable":51,"ac-feature/touchAvailable":53}],57:[function(b,d,a){b("ac-polyfills");
var c=b("./FeatureDetect");var f=b("./defaultTests");d.exports=new c(document.documentElement,f);
d.exports.FeatureDetect=c},{"./FeatureDetect":55,"./defaultTests":56,"ac-polyfills":"ac-polyfills"}],58:[function(b,c,a){arguments[4][1][0].apply(a,arguments)
},{"./ac-browser/BrowserData":59,"./ac-browser/IE":60,dup:1}],59:[function(b,c,a){arguments[4][33][0].apply(a,arguments)
},{"./data":61,dup:33}],60:[function(b,c,a){arguments[4][3][0].apply(a,arguments)
},{dup:3}],61:[function(b,c,a){arguments[4][35][0].apply(a,arguments)},{dup:35}],62:[function(c,d,b){c("ac-polyfills/Array/prototype.forEach");
var a=Object.prototype.hasOwnProperty;d.exports=function f(){var h;var g;if(arguments.length<2){h=[{},arguments[0]]
}else{h=[].slice.call(arguments)}g=h.shift();h.forEach(function(j){if(j!=null){for(var i in j){if(a.call(j,i)){g[i]=j[i]
}}}});return g}},{"ac-polyfills/Array/prototype.forEach":64}],63:[function(b,c,a){if(!Array.prototype.filter){Array.prototype.filter=function d(l,k){var j=Object(this);
var f=j.length>>>0;var h;var g=[];if(typeof l!=="function"){throw new TypeError(l+" is not a function")
}for(h=0;h<f;h+=1){if(h in j&&l.call(k,j[h],h,j)){g.push(j[h])}}return g}}},{}],64:[function(b,c,a){if(!Array.prototype.forEach){Array.prototype.forEach=function d(k,j){var h=Object(this);
var f;var g;if(typeof k!=="function"){throw new TypeError("No function object passed to forEach.")
}for(f=0;f<this.length;f+=1){g=h[f];k.call(j,g,f,h)}}}},{}],65:[function(b,c,a){(function(){var d=Array.prototype.slice;
try{d.call(document.documentElement)}catch(f){Array.prototype.slice=function(n,j){j=(typeof j!=="undefined")?j:this.length;
if(Object.prototype.toString.call(this)==="[object Array]"){return d.call(this,n,j)
}var l,h=[],k,g=this.length;var o=n||0;o=(o>=0)?o:g+o;var m=(j)?j:g;if(j<0){m=g+j
}k=m-o;if(k>0){h=new Array(k);if(this.charAt){for(l=0;l<k;l++){h[l]=this.charAt(o+l)
}}else{for(l=0;l<k;l++){h[l]=this[o+l]}}}return h}}}())},{}],66:[function(b,c,a){if(!Array.prototype.some){Array.prototype.some=function d(k,j){var g=Object(this);
var f=g.length>>>0;var h;if(typeof k!=="function"){throw new TypeError(k+" is not a function")
}for(h=0;h<f;h+=1){if(h in g&&k.call(j,g[h],h,g)===true){return true}}return false
}}},{}],67:[function(b,c,a){
/*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js*/
...
h.call(this,l)}}};g("add");g("remove")}f.classList.toggle("c3",false);if(f.classList.contains("c3")){var d=DOMTokenList.prototype.toggle;
DOMTokenList.prototype.toggle=function(h,i){if(1 in arguments&&!this.contains(h)===!i){return i
}else{return d.call(this,h)}}}f=null}())}}},{}],68:[function(b,c,a){window.matchMedia=window.matchMedia||(function(i,j){var g,d=i.documentElement,f=d.firstElementChild||d.firstChild,h=i.createElement("body"),k=i.createElement("div");
k.id="mq-test-1";k.style.cssText="position:absolute;top:-100em";h.style.background="none";
h.appendChild(k);return function(l){k.innerHTML='&shy;<style media="'+l+'"> #mq-test-1 { width:42px; }</style>';
d.insertBefore(h,f);g=k.offsetWidth===42;d.removeChild(h);return{matches:g,media:l}
}}(document))},{}],69:[function(c,d,a){var b=c("ac-browser");var f=c("./isOldTablet");
...
}else{if(b.name=="IE"){return false}else{return true}}}}}})()},{"./isOldTablet":70,"ac-browser":1}],70:[function(c,d,b){var a=c("ac-feature");
var f=function(){if(!a.isTablet()){return false}if(a.isRetina()){return false}var g=0;
try{var h=document.createElement("canvas");var k=h.getContext("experimental-webgl");
var i=(k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic"));
if(i){g=k.getParameter(i.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}return g<=2}catch(j){return false
}};d.exports=f()},{"ac-feature":24}],71:[function(f,c,g){var d=f("ac-headjs");var h=f("ac-feature");
var j=f("ac-browser");var a=f("ac-classlist");var b=f("./_shared/utils/animationCapable");
var i=(function(){return{initialize:function(){var k="intro-load";var l=5000;d.htmlClass();
new d.FeatureDetect(document.documentElement,{ios:this.isIOS,ios7:this.isIOS7,mp4:this.canPlayVideo,webgl:h.webGLAvailable,transforms:h.threeDTransformsAvailable,tablet:this.isTablet,handheld:this.isHandheld,ff:this.isFirefox,chrome:this.isChrome,ios9:this.isIOS9,"inline-video":this.canPlayInlineVideo,"mask-box-image":this.supportsMasking,"animation-capable":this.animationCapable}).htmlClass();
if(this.shouldPrepareOverviewHeroIntro()){a.add(document.documentElement,k);a.add(document.documentElement,"intro-start");
window.introLoadTimeout=setTimeout(function(){a.remove(document.documentElement,k);
a.remove(document.documentElement,"intro-ui-hide");a.remove(document.documentElement,"intro-active");
a.remove(document.documentElement,"intro-start");a.add(document.documentElement,"intro-fallback");
if(window.AC&&window.AC.OverviewStatusProxy&&!window.AC.OverviewStatusProxy.ready){window.AC.OverviewStatusProxy.trigger("ready")
}},l)}return this},isIOS:function(){return j.os=="iOS"},isIOS7:function(){return j.os=="iOS"&&Math.abs(j.version)<8
},isIOS9:function(){return j.os=="iOS"&&Math.abs(j.version)>=9},isFirefox:function(){return j.name.toLowerCase()==="firefox"
},isChrome:function(){return j.name.toLowerCase()==="chrome"},canPlayVideo:function(){try{var k=document.createElement("VIDEO");
if(k.canPlayType&&k.canPlayType("video/mp4").replace(/no/," ")){return true}}catch(l){}return false
},canPlayInlineVideo:function(){if((navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPod/i))&&(j.os=="iOS"&&Math.abs(j.version)<=9)){return false
}else{return true}},supportsMasking:function(){var l=j.name.toLowerCase(),k=j.version;
if((l==="chrome"&&k>=31)||(l==="safari"&&k>=8)){return true}return false},animationCapable:function(){return b
},shouldPrepareOverviewHeroIntro:function(){if(a.contains(document.documentElement,"page-overview-document-element")&&h.threeDTransformsAvailable()){return true
}},isHandheld:function(){return h.isHandheld()},isTablet:function(){return h.isTablet()
}}}());c.exports=i.initialize()},{"./_shared/utils/animationCapable":69,"ac-browser":1,"ac-classlist":12,"ac-feature":24,"ac-headjs":57}]},{},[71]);