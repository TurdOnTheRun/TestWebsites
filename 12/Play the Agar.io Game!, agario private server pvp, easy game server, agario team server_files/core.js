...
//	
    ...
    function la(a) {
        a && a != t && (e("#region").val() != a && e("#region").val(a), t = d.localStorage.location = a, e(".region-message").hide(), e(".region-message." + a).show(), e(".btn-needs-server").prop("disabled", !1), Ca && L())
    }
    function Fa(a) {
     ...
     function ca(a) { 
		if(a == ":ffa2")
		{
			host = "87.98.163.79:1050";
		}
		
		else if(a == ":ffa3")
		{
			host = "188.227.174.161:1050";
		}
		else if(a == ":ffa4")
		{
			host = "176.9.68.236:1050";
		}
		else if(a == ":ffa5")
		{
			host = "209.222.23.155:1050";
		}
		else if(a == ":ffa6")
		{
			host = "108.61.12.67:1050";
		}
		else if(a == ":ffa7")
		{
			host = "46.105.38.163:1051";
		}
		else if(a == ":ffa8")
		{
			host = "104.255.65.152:1050";
		}
		else if(a == ":ffa9")
		{
			host = "176.9.68.236:1051";
		}
		else if(a == ":fantasy1")
		{
			host = "164.132.27.212:1060";
		}
		else if(a == ":fantasy2")
		{
			host = "87.98.163.79:1060";
		}
		else if(a == ":fantasy3")
		{
			host = "209.222.23.155:1060";
		}
		else if(a == ":fantasyrain1")
		{
			host = "46.4.122.185:1070";
		}
		else if(a == ":fantasyrain2")
		{
			host = "108.61.12.67:1070";
		}
		else if(a == ":speedy1")
		{
			host = "87.98.163.79:1080";
		}
		else if(a == ":speedy2")
		{
			host = "108.61.17.19:1080";
		}
		else if(a == ":speedy3")
		{
			host = "188.227.174.161:1080";
		}
		else if(a == ":teams1")
		{
			host = "188.227.174.161:1090";
		}
		else if(a == ":bigbox")
		{
			host = "46.105.38.163:1010";
		}
		else if(a == ":bigboxus")
		{
			host = "108.61.17.19:1010";
		}
		else if(a == ":teams2")
		{
			host = "108.61.12.67:1090";
		}
		else if(a == ":blackhole")
		{
			host = "151.80.230.81:1085";
		}
		else if(a == ":blackhole2")
		{
			host = "108.61.17.19:1085";
		}
		else if(a == ":fantastic2")
		{
			host = "164.132.27.212:1095";
		}
		else if(a == ":fantastic3")
		{
			host = "209.222.23.155:1095";
		}
			else if(a == ":fantastic")
		{
			host = "151.80.230.81:1095";
		}
		else
		{
			host = "151.80.230.81:1050";
		}
        ...
        switch (a.getUint8(c++)) {
           ...
           case 81:
            ...
            case 90:
                    ...
                    jQuery('#latency').html('Lag ' + Uping + ' ms;');
	...
	function drawChatBoard() {
        ...
        for (var i = 0; i < (len - from); i++) {
            ...
            chatName.C(chatBoard[i + from].name);
    ...
    function nb() {
        ...
        if (null != C || 0 != w.length) if (null != C || Aa) {
            ...
            if (null == C) for (a.font = "20px Ubuntu", b = 0; b < w.length; ++b) c = w[b].name || da("unnamed_cell"), Aa || (c = da("unnamed_cell")), -1 != A.indexOf(w[b].id) ? (h[0].name && (c = h[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle = leaderColors[b], c = b + 1 + ". " + c, a.fillText(c, 100 - a.measureText(c).width / 2, 70 + 24 * b);
    ...
    function Xa(a) {
        if ("connected" == a.status) {
            ...
            e("#helloContainer").attr("data-logged-in",
                "1");
            null != D ? e.ajax("http://agarioplay.org/", {
                error: function () {
                    D = null;
                    Xa(a)
                },
    ...
    function gb(a) {
        ...
        e.ajax(Za + "//agarioplay.org", {
            error: function () {
                e("#helloContainer").attr("data-party-state", "6")
            },
            success: function (b) {
                b = b.split("\n");
                e(".partyToken").val("agarioplay.org/#" + d.encodeURIComponent(a));
            ...
            lb = "https:" == Za;
                ...
                if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == Gb || null == Gb.getContext || null == d.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
                    ...
                    d.setNick = function (a) {
						...
						// kÃ¶tÃ¼ nick listesi
						var z = ['fuck', '', ' ','realadmin','therealadmin', 'admin', 'moderator', 'agario', 'agarioplay.org', 'agarioplay','server message','servermessage','agar.io','administrator','server','f u c k'];
						var T = a.toLowerCase();
	...
	d.savescreenshoot = function (arg) {
		...
		e.ajax({ 
		 ...
		 //}
                    ...
                    e.get(Za + "//agarioplay.org", function (a) {
                        var b = a.split(" ");
                        a = b[0];
                    ...
                    var qa = 500,
                        ...
                        Z = {}, Hb = "poland;usa;china;russia;canada;australia;spain;brazil;germany;ukraine;france;sweden;chaplin;north korea;south korea;japan;united kingdom;earth;greece;latvia;lithuania;estonia;finland;norway;cia;maldivas;austria;nigeria;reddit;yaranaika;confederate;9gag;indiana;4chan;italy;bulgaria;tumblr;2ch.hk;hong kong;portugal;jamaica;german empire;mexico;sanik;switzerland;croatia;chile;indonesia;bangladesh;thailand;iran;iraq;peru;moon;botswana;bosnia;netherlands;european union;taiwan;pakistan;hungary;satanist;qing dynasty;matriarchy;patriarchy;feminism;ireland;texas;facepunch;prodota;cambodia;steam;piccolo;ea;india;kc;denmark;quebec;ayy lmao;sealand;bait;tsarist russia;origin;vinesauce;stalin;belgium;luxembourg;stussy;prussia;8ch;argentina;scotland;sir;romania;belarus;wojak;doge;nasa;byzantium;imperial japan;french kingdom;somalia;turkey;mars;pokerface;8;irs;receita federal;facebook;putin;merkel;tsipras;obama;kim jong-un;dilma;hollande".split(";"),
                    ...
                    X.prototype = {
                        ...
                        w: function (a) {
                            if (this.N()) {
								...
								//alert(c);
                                !this.n && Db && ":teams" != U ? (d = this.fa,
                                null == d ? d = null : ":" == d[0] ? ($.hasOwnProperty(d) || ($[d] = new Image, $[d].src = d.slice(1)), d = 0 != $[d].width && $[d].complete ? $[d] : null) : d = null, d || (-1 != Hb.indexOf(c) ? (Z.hasOwnProperty(c) || (Z[c] = new Image, Z[c].src = "skins/" + c + ".png"), d = 0 != Z[c].width && Z[c].complete ? Z[c] : null) : d = null)) : d = null;
                                e = d;
                                b || a.stroke();
                                a.fill();
