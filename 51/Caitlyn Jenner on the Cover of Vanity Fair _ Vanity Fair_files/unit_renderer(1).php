function jvxAdObjectfireIT(){
						jvxAdObjectfireImprTracker('https://ad.doubleclick.net/ddm/ad/N4478.condenast.comOX2307/B9517944.129290232;sz=1x1;ord=112;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?', 'img');
														}
function jvxAdObjectfireImprTracker(url, elType){
	var elNode = "";
	if(elType == 'script'){
...
if(self != top){
	jvxAdObjectTraffickedInFrame = true;
}
try{
	if(top != parent){
		// Nested friendly frame case
		jvxAdObjectInNestedFrame = true;
	}
}catch(e){
	jvxAdObjectInNestedFrame = false;
}


	if(self != top){ /* Tag is rendered inside iframe. So we need to bust out of the iframe. */
				try{	
			var parameters = {};
			parameters.foreignWindow = window;
			parameters.hostWindow = top.window;
			if(!top.window.jivoxIBusterAdObject){
				top.window.jivoxIBusterAdObject = {};
			}
			if(!jvxAdObjectInNestedFrame){
				top.window.jivoxIBusterAdObject["jvxAdObject"] = parameters;            
				var script = top.window.document.createElement('script');
				script.type = 'text/javascript';
								script.src = "https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=13&bDim=5x5&bUnitId=1300&siteId=554580bc721c8d&campaignId=85034&es_pId=x5XN67&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%253Fxai%253DAKAOjssjnsZOvy-0sbXaUrwez89otgvZpMzdx7fS7-jI6gvHletdTgY91QcBctCpRF34Iorb3q4wmKy0ioOkVeVwzBdNv8ipco2Fi75q1X_aR923UuZfX0-sbg5sgAi6SEnVT3Cyrs-56X5Z0CzE6gQuB4l63kudaBukDo4X0eQ%2526sai%253DAMfl-YSANTt2V7cFbkCIqtRL9QMSy8mVY3pDje4I7AEkWZXfFh4BTWuuQ67MP9w21SBYP-Nq-gUWdQkHtA%2526sig%253DCg0ArKJSzNxgC2IZV7JqEAE%2526urlfix%253D1%2526adurl%253D&r=775267308&objectName=jvxAdObject&npl=1&busted=1&bustType=1";
												top.window.document.body.appendChild(script);
								document.write('<img src="https://d1ytpfpcvrpmqk.cloudfront.net/assets/1x1.png" border="0" width="5" height="5"/>');
							}
		}catch(e){
						try{
				$sf.ext.register("5", "5", false);
				jvxAdObjectSafeFrameSupported = true;
			}catch(e){								// Start
				jvxAdObjectSafeFrameSupported = false;
							/* Tag is trafficked inside non-friendly iframe */
				try{
										throw true;
										if(!jvxAdObjectInNestedFrame){
						var iBusterURLHost = "";
						var hostNameRegExp = new RegExp("^(?:http[s]?://)?([^/]+)" , "i");
						if(document.referrer != ""){
							var currentDocumentHost = document.referrer.match(hostNameRegExp)[0]; 
							var iBusterURL = "";
							var targetIBusterURL = iBusterURL.replace(iBusterURLHost, currentDocumentHost);
														targetIBusterURL += "&busted=1&bustType=1";
																					
														document.write('<iframe src="'+targetIBusterURL+'" id="" name="" width="5" height="5" frameborder="0" allowtransparency="true" scrolling="no" style="background:transparent;"></iframe>');
													}else{
							var targetIBusterURL = "";
														targetIBusterURL += "&busted=1&bustType=1";
					...
					jvxAdObjectCanBustFromFrame = false;
				}
			}					// End of catch()
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
	...
	function CreativeUnit(uniqId){
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=13&bDim=5x5&bUnitId=1300&siteId=554580bc721c8d&campaignId=85034&es_pId=x5XN67&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%253Fxai%253DAKAOjssjnsZOvy-0sbXaUrwez89otgvZpMzdx7fS7-jI6gvHletdTgY91QcBctCpRF34Iorb3q4wmKy0ioOkVeVwzBdNv8ipco2Fi75q1X_aR923UuZfX0-sbg5sgAi6SEnVT3Cyrs-56X5Z0CzE6gQuB4l63kudaBukDo4X0eQ%2526sai%253DAMfl-YSANTt2V7cFbkCIqtRL9QMSy8mVY3pDje4I7AEkWZXfFh4BTWuuQ67MP9w21SBYP-Nq-gUWdQkHtA%2526sig%253DCg0ArKJSzNxgC2IZV7JqEAE%2526urlfix%253D1%2526adurl%253D&r=775267308&objectName=jvxAdObject&adUnitId=1300&jvxSessionId=1460005437.4504';
				this.baseURL += '&base=1';
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		recordEvent:function(eventId,addnlParams){
				...
				var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "85034/554580bc721c8d/14/jvxSId_1460005437.4504";
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=13&bDim=5x5&bUnitId=1300&siteId=554580bc721c8d&campaignId=85034&es_pId=x5XN67&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%253Fxai%253DAKAOjssjnsZOvy-0sbXaUrwez89otgvZpMzdx7fS7-jI6gvHletdTgY91QcBctCpRF34Iorb3q4wmKy0ioOkVeVwzBdNv8ipco2Fi75q1X_aR923UuZfX0-sbg5sgAi6SEnVT3Cyrs-56X5Z0CzE6gQuB4l63kudaBukDo4X0eQ%2526sai%253DAMfl-YSANTt2V7cFbkCIqtRL9QMSy8mVY3pDje4I7AEkWZXfFh4BTWuuQ67MP9w21SBYP-Nq-gUWdQkHtA%2526sig%253DCg0ArKJSzNxgC2IZV7JqEAE%2526urlfix%253D1%2526adurl%253D&r=775267308&objectName=jvxAdObject';
											this.baseURL += '&jvxSessionId=1460005437.4504';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=13&bDim=5x5&&siteId=554580bc721c8d&campaignId=85034&es_pId=x5XN67&jvxVer=2&cMacro=https%3A%2F%2Fadclick.g.doubleclick.net%2Fpcs%2Fclick%253Fxai%253DAKAOjssjnsZOvy-0sbXaUrwez89otgvZpMzdx7fS7-jI6gvHletdTgY91QcBctCpRF34Iorb3q4wmKy0ioOkVeVwzBdNv8ipco2Fi75q1X_aR923UuZfX0-sbg5sgAi6SEnVT3Cyrs-56X5Z0CzE6gQuB4l63kudaBukDo4X0eQ%2526sai%253DAMfl-YSANTt2V7cFbkCIqtRL9QMSy8mVY3pDje4I7AEkWZXfFh4BTWuuQ67MP9w21SBYP-Nq-gUWdQkHtA%2526sig%253DCg0ArKJSzNxgC2IZV7JqEAE%2526urlfix%253D1%2526adurl%253D&r=775267308&objectName=jvxAdObject'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1460005437.4504';
