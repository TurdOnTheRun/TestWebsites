...
var videoVO1 = {
    ...
    element: null,
    videoDuration: 11000,
    sourceMP4: "Outlander_S2_728x90_Prog_Video.mp4",
    sourceWEBM: "Outlander_S2_728x90_Prog_Video.webm",
    imageSequenceImgId: "image-sequence-1-image-container",
    imageSequenceImg: null,
    imageSequenceSource: "Outlander_S2_728x90_Prog_Video.txt",
...
window.onload = function () {
    ...
    initialTunein_container.style.visibility = "hidden";
    initial_TT_container.style.visibility = "hidden";
    resolve_TT_container = document.getElementById("resolve-tt-container");
    resolveTunein_container = document.getElementById("resolve-tunein-container");
    ...
    if ((currentMonth == 2) || (currentMonth == 3 && currentDay <= 4)) {
        initialTunein_container.style.backgroundPosition = "0px -96px";
        resolveTunein_container.style.backgroundPosition = "0px -96px";
        isPremessaging = true;
    } else if (currentMonth == 3 && (currentDay >= 5 && currentDay <= 7)) {
        initialTunein_container.style.backgroundPosition = "0px -64px";
        resolveTunein_container.style.backgroundPosition = "0px -64px";

    } else if (currentMonth == 3 && currentDay == 8) {
        initialTunein_container.style.backgroundPosition = "0px -32px";
        resolveTunein_container.style.backgroundPosition = "0px -32px";
