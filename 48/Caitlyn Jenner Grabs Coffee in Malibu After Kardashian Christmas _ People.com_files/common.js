/* SiteCatalyst code version: H.24.3. Copyright 1996-2011 Adobe, Inc. All Rights Reserved More info available at http://www.omniture.com (pe 2015-03-23) */
var s_time=s_gi(s_account)
var s_time_rsid2="timeglobalvideo";
if(/(file:\/\/\/|localhost|dev\.people\.com|qa\.people\.com|qa-esearch|dev-esearch|v5\.timeinc\.net)/.test(location.href)){s_time_rsid2="timeglobalvideodev";}
...
//s_time.dc="122"
s_time.trackingServer="metrics.people.com";
s_time.trackingServerSecure="smetrics.people.com";
/************************** TII FUNCTIONS SECTION *******************/
...
/* MB - 08/19/09 - Update Plugins for H.20.2 - 8-19-09              */
...
/* MB - 09/06/07 - Added split & apl function to support LTV        */ 
...
+" v==k?'':v");
/* MB - 08/19/09 - Not upgrading to getTimeParting 1.4 so as to not */
/*                 change the default of 30 mins from to 15         */ 
/*
...
s_time.m_i("Media");
/* Survey Variable Settings */
//s_time.loadModule("Survey")
//var s_sv_dynamic_root = "survey.122.2o7.net/survey/dynamic"
//var s_sv_gather_root = "survey.122.2o7.net/survey/gather"
/* Module: Survey */
s_time.m_Survey_c="var m=s.m_i(\"Survey\");m.launch=function(i,e,c,o,f){this._boot();var m=this,g=window.s_sv_globals||{},l,j;if(g.unloaded||m._blocked())return 0;i=i&&i.constructor&&i.constructor==Array?"
