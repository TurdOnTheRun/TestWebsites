...
var resolveTunein_container = null;
var cta_pre_container = null;
var cta_post_container = null;
var cta_pulse_pre_container = null;
var cta_pulse_post_container = null;
/* Data */
var isIE = false;
...
var videoVO1 = {
    ...
    element: null,
    videoDuration: 11000,
    sourceMP4: "Outlander_S2_300x250_Prog.mp4",
    sourceWEBM: "Outlander_S2_300x250_Prog.webm",
    imageSequenceImgId: "image-sequence-1-image-container",
    imageSequenceImg: null,
    imageSequenceSource: "Outlander_S2_300x250_Prog.txt",
...
window.onload = function () {
    ...
    resolveTunein_container = document.getElementById("tunein-container");
    cta_pre_container = document.getElementById("cta-container-pre")
    cta_post_container = document.getElementById("cta-container-post")
    cta_pulse_pre_container = document.getElementById("cta-shimmer-pre-container")
    cta_pulse_post_container = document.getElementById("cta-shimmer-post-container")
    ...
    if ((currentMonth == 2) || (currentMonth == 3 && currentDay <= 4)) {
        initialTunein_container.style.backgroundPosition = "0px -48px";
        resolveTunein_container.style.backgroundPosition = "0px -75px";
        cta_pre_container.style.display = "block";
        cta_post_container.style.display = "none";
        cta_pulse_pre_container.style.display = "block";
        cta_pulse_post_container.style.display = "none";
        isPreMessaging = true;
    } else if (currentMonth == 3 && (currentDay >= 5 && currentDay <= 7)) {
        initialTunein_container.style.backgroundPosition = "0px -32px";
        resolveTunein_container.style.backgroundPosition = "0px -50px";
        cta_pre_container.style.display = "none";
        cta_post_container.style.display = "block";
        cta_pulse_pre_container.style.display = "none";
        cta_pulse_post_container.style.display = "block";
    } else if (currentMonth == 3 && currentDay == 8) {
        initialTunein_container.style.backgroundPosition = "0px -16px";
        resolveTunein_container.style.backgroundPosition = "0px -25px";
        cta_pre_container.style.display = "none";
        cta_post_container.style.display = "block";
        cta_pulse_pre_container.style.display = "none";
        cta_pulse_post_container.style.display = "block";
        ...
        resolveTunein_container.style.backgroundPosition = "0px -0px";
        cta_pre_container.style.display = "none";
        cta_post_container.style.display = "block";
        cta_pulse_pre_container.style.display = "none";
        cta_pulse_post_container.style.display = "block";
...
function pageLoadedHandler() {
    ...
    setTimeout(function () {
        ...
        button_clicktag_2.addEventListener("click", stateResolveClicktagHandler, false);
...
function mouseEnterHandler(e) {
    if (isPreMessaging) {
        cta_pulse_pre_container.classList.add('animatePulse');
    } else {
        cta_pulse_post_container.classList.add('animatePulse');
    }
}
...
function mouseExitHandler(e) {
    if (isPreMessaging) {
        cta_pulse_pre_container.classList.remove('animatePulse');
    } else {
        cta_pulse_post_container.classList.remove('animatePulse');
    }
}
