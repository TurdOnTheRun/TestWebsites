...
(function (global) {
    ...
    function newContext(contextName) {
        ...
        return (context = {
            ...
            configure: function (cfg) {
                ...
                //config object before require.53ktjh9r78d8ozqkhscbip0oo.js is loaded.
    ...
    if (isBrowser) {
        //Figure out baseUrl. Get it from the script tag with require.53ktjh9r78d8ozqkhscbip0oo.js in it.
        eachReverse(scripts(), function (script) {
