...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.foxsports.com";
...
if (!janrain.settings.actionText)janrain.settings.actionText = " SOCIAL SIGN IN";
...
if (typeof janrain.settings.buttonBorderColor === 'undefined')janrain.settings.buttonBorderColor = "#c0c4d6";
if (typeof janrain.settings.buttonBorderRadius === 'undefined')janrain.settings.buttonBorderRadius = "2";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "ecdahnogiidjagdjhfpp";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.foxsports.com";
...
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "380390622023704";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.foxsports.com";
...
if (typeof janrain.settings.share.providers === 'undefined')janrain.settings.share.providers = ["email","facebook","twitter"];
