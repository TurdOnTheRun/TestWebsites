...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+isSocialMediaShared(aolTacRef())+document.referrer+catmanduLogger()+catmandu_integration_mcc_m(aolTacRef(), document.referrer, '/search.*[?&]q=([^&]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='Aadi/politics|BADIhill/|BADIelections|BADIpollster|BPFZmoney/|BSBZsmall-business|BAAUbusiness|BAIZcelebrity-kids|BTEVtelevision|BMOVfilm/|BABUentertainment|BABVbook|BADNtechnology|BABUcomedy|BAAObasketball|EAAPeball|BAANfootball|BSPTsports|BADNtech/|BAFZstyle|BWDNworld|BTVLtravel|BDFTnutrition|BFODfood|BHLThealth|AHLT-health|AEDU/education|BEQJgreen|BARTarts|AFDYiphone-4s|AADGhuffingtonpost.com|AECIfacebook.com/l.php|AEUMtwitter.com|AFIXsocialnetwork:share:facebook:read|TECM|TECI:facebook|UFILgoogleplus|UECKlifestream|UEUMtwitter|UEWTfacebook:like|[FIQok:recommend|UFIWstumbleupon';
var ANAXLSL='';
var ANCB1=0;
var ANCB3=0;
var ANRD='';
...
return"";
}function isSocialMediaShared(ref){
if(ref.search(/(facebook.com|twitter.com)/i)>-1){
return ref;
}
return"";
...
var CMMISS=-1;
var CMKW="";
function catmandu_integration_mcc_m(ref,site,sitesearch,app){
...
var kw=false;
try{
if(ref.search(/(google\.co|bing\.co|search\.yahoo\.co|search\.aol\.co)/i)>-1){
