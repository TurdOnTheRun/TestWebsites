...
},{"../../utils/is_visible":9,"../../utils/opportunity_checker":12,"./config":2}],2:[function(require,module,exports){
'use strict';
...
},{"../../utils/current_script":8,"../../utils/post_message":14,"../../utils/uuid":18,"../../vendor/jquery":20}],3:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  track: function track(event) {
    ...
    var commands = arguments[2] === undefined ? [EVENT_COUNT, EVENT_COUNT_BY_SITE] : arguments[2];
...
},{"../../utils/lambda":10,"./config":2,"bowser":22}],4:[function(require,module,exports){
'use strict';
...
var cleanupSimilarUnits = function cleanupSimilarUnits() {
  ...
  var pageUnits = arguments[0] === undefined ? [] : arguments[0];
...
module.exports = {
  cleanAppend: function cleanAppend(widget) {
    var pageUnits = arguments[1] === undefined ? [] : arguments[1];
...
},{"../../utils/ass_asset":7,"../../vendor/jquery":20,"./config":2}],5:[function(require,module,exports){
'use strict';
...
},{"../../utils/log":11,"../../utils/placement_manager":13,"./config":2,"./event_tracker":3}],6:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  track: function track(eventType) {
    var additional = arguments[1] === undefined ? {} : arguments[1];
...
},{"../../utils/lambda":10,"../../utils/log":11,"../../utils/url_tools":17,"./config":2,"bowser":22}],7:[function(require,module,exports){
(function() {
...
},{"./log":11}],9:[function(require,module,exports){
...
},{"./log":11,"./url_tools":17,"./uuid":18,"./virool_namespace":19}],13:[function(require,module,exports){
...
},{"./../vendor/jquery":20,"./log":11,"./smart":15,"./virool_namespace":19}],14:[function(require,module,exports){
...
PostMessageManager = (function() {
  ...
  PostMessageManager.prototype._jsonMessageHandler = function(event) {
    var e, i, len, parsedMessage, ref, results, subscriber;
    try {
...
},{"./../vendor/jquery":20,"./smart_helpers":16}],16:[function(require,module,exports){
'use strict';
...
},{"./log":11}],17:[function(require,module,exports){
var URLTools,
  hasProp = {}.hasOwnProperty;
...
},{"./js/backfill/loader/checkers":1,"./js/backfill/loader/config":2,"./js/backfill/loader/event_tracker":3,"./js/backfill/loader/html":4,"./js/backfill/loader/placement_finder":5,"./js/backfill/loader/rubicon_tracker":6,"./js/utils/lambda":10,"./js/utils/virool_namespace":19,"./js/vendor/jquery":20}],22:[function(require,module,exports){
/*!
