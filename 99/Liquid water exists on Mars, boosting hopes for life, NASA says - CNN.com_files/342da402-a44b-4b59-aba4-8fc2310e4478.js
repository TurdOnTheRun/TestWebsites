...
// Generated on: 4/6/2016 5:02:42 AM (UTC 4/6/2016 10:02:42 AM)
...
ClickTaleCDNHTTPSRewrite('https://cdnssl.clicktale.net/www04/pcc/342da402-a44b-4b59-aba4-8fc2310e4478.js?DeploymentConfigName=Release_30032016&Version=1'):
'http://cdn.clicktale.net/www04/pcc/342da402-a44b-4b59-aba4-8fc2310e4478.js?DeploymentConfigName=Release_30032016&Version=1');
...
window.ClickTaleSettings.RewriteRules = {
	OnBeforeRewrite: function (rewriteApi) {
		...
		if ((document.location.pathname.indexOf("/election/") > -1) || (document.location.pathname.indexOf("/election") > -1)) {
		    rewriteApi.add({
		        pattern: new RegExp('(href=")(?!http:)(.*?\.css)', 'gim'),
		        replace: "$1http://dummytest.clicktale-samples.com/CNN$2"
		    });
		} else {
		    rewriteApi.add({
...
var ClickTaleOnReady = function()
{
	...
	window.ClickTaleUIDCookieName = "WRUID20160330";
window.ctlib = {};
